...
function generateMission(){
        ...
        document.getElementById("MissionType").innerHTML=(missionType);
        ...
        document.getElementById("MissionTableMap").innerHTML=("<a href=\""+missionMap+"\" target=\"_blank\"><img src=\"/static/images/"+missionMap+"\" alt=\"Map for "+missionName+"\" width=\"100%\"/></a>");	
    }
function displayMission () { //used by missions.html to load a mission which is chosen by the end user
    ...
    //Write out the mission Victory Conditions
    document.getElementById("MissionTableMap").innerHTML=("<a target=\"_blank\" href=\" "+VARmissionMap+"\"><img src=\"/static/images/"+VARmissionMap+"\" width=\"100%\" alt\" Mission map for "+VARmissionName+"/></a>");
